...
export default function Home({history}) {
   ...
   const loadGamesActivities = async () => {
      const response = await fetch("/api/gameActivities", {
         method: "GET",
         headers: {
   ...
   return (
      <Content width="800px">
         <Paragrafo>Bem vindo ao <strong>Sunday-Games.com</strong></Paragrafo>
         <Paragrafo>Esse é seu canvas para organizar seus games em desenvolviment</Paragrafo>
         <Paragrafo>Crie novos desenvolvimentos e mantenha elas atualizadas</Paragrafo>
